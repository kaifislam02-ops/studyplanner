        ...
        <div className={`flex items-center justify-between p-6 border-b ${borderClass}`}>
          <div>
            ...
            <p className={`text-sm ${textMuted} mt-1`}>
              {mode === "signin" ? "Sign in to sync your data" : "Sign up to get started"}
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={loading}
              className={`w-full flex items-center justify-center gap-3 px-4 py-3 ${inputBg} border rounded-lg font-medium transition-colors hover:border-blue-500 disabled:opacity-50`}
            >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className={`px-2 ${bgClass} ${textMuted}`}>Or continue with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-4 py-3 rounded-lg font-medium transition-colors disabled:opacity-50"
            >
